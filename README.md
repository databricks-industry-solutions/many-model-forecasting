...
- Feb 2026: Added a new interactive app to explore the results of forecasting. Try it out [here](https://github.com/databricks-industry-solutions/many-model-forecasting/blob/main/apps/).
