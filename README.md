...
## What's New
For local models, use a cluster with [Databricks Runtime 17.3LTS for ML](https://docs.databricks.com/en/release-notes/runtime/17.3lts-ml.html). For global models, use a cluster with [Databricks Runtime 18.0 for ML](https://docs.databricks.com/en/release-notes/runtime/18.0-ml.html). For foundation models, use a cluster with [Databricks Runtime 15.4LTS for ML](https://docs.databricks.com/en/release-notes/runtime/15.4lts-ml.html).
